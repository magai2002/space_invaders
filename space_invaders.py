...
HEALTH_KIT = pygame.image.load(os.path.join('assets', 'health_kit.png'))
...
def main():
	...
	while run:
		...
		if len(enemies) == 0:
			...
			if level >= 2 and len(health_kits) == 0:
				health_kit = Health_Kit(random.randrange(50, WIDTH-100), random.randrange(50, HEIGHT-100))
				health_kits.append(health_kit)
